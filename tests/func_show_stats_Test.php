...
class ShowStatsTest extends PHPUnit_Framework_TestCase{
    ...
    public function testWhoIsYour(){
        ...
        $expected_output = "<p>Your Totals --  10, 20, 30<br />Total: 60 <br />Reps per person in office: N/A<br />Reps per person per day in office: N/A<br /><br />Reps per person participating: N/A<br />Percent participating: N/A%<br />";
    ...
    public function testWhoIsCalifornia(){
        ...
        $expected_output = "<p>California Totals --  10, 20, 30<br />Total: 60 <br />Reps per person in office: 12<br />Reps per person per day in office: 0<br /><br />Reps per person participating: 30<br />Percent participating: 40%<br />";
    ...
    public function testWhoIsBoulder(){
        ...
        $expected_output = "<p>Boulder Totals --  10, 20, 30<br />Total: 60 <br />Reps per person in office: 12<br />Reps per person per day in office: 0<br /><br />Reps per person participating: 30<br />Percent participating: 40%<br />";
    ...
    public function testWhoIsDenver(){
        ...
        $expected_output = "<p>Denver Totals --  10, 20, 30<br />Total: 60 <br />Reps per person in office: 12<br />Reps per person per day in office: 0<br /><br />Reps per person participating: 30<br />Percent participating: 40%<br />";
